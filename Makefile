...
INTERNAL=github.com/ashir6892/thor/cmd/thor/internal
...
THOR_HOME?=$(HOME)/.thor
WORKSPACE_DIR?=$(THOR_HOME)/workspace
...
## build: Build the thor binary for current platform
build: generate
...
## build-all: Build thor for all platforms
build-all: generate
	@echo "Building for multiple platforms..."
	@mkdir -p $(BUILD_DIR)
...
## install: Install thor to system and copy builtin skills
install: build
...
## uninstall: Remove thor from system
uninstall:
...
## uninstall-all: Remove thor and all data
uninstall-all:
	@echo "Removing workspace and skills..."
	@rm -rf $(THOR_HOME)
	@echo "Removed workspace: $(THOR_HOME)"
...
help:
	...
	@echo "  WORKSPACE_DIR           # Workspace directory (default: ~/.thor/workspace)"
