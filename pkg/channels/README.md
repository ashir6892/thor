# Thor Channel System Refactor: Complete Development Guide

> **Branch**: `refactor/channel-system`
> **Status**: Active development (~40 commits)
> **Scope**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/thor/internal/gateway/`
...
│   ├── init.go
│   └── discord.go
├── slack/ line/ onebot/ dingtalk/ feishu/ wecom/ qq/ whatsapp/ maixcam/ nano/
│   └── ...
...
import (
    "github.com/ashir6892/thor/pkg/bus"
    "github.com/ashir6892/thor/pkg/config"
)
...
import (
    "github.com/ashir6892/thor/pkg/bus"
    "github.com/ashir6892/thor/pkg/channels"     // Reference parent package
    "github.com/ashir6892/thor/pkg/config"
    "github.com/ashir6892/thor/pkg/identity"      // New
    "github.com/ashir6892/thor/pkg/media"          // New (if media support needed)
)
```
...
import (
    "github.com/ashir6892/thor/pkg/bus"
    "github.com/ashir6892/thor/pkg/channels"
    "github.com/ashir6892/thor/pkg/config"
)
...
```go
// cmd/thor/internal/gateway/helpers.go
import (
    _ "github.com/ashir6892/thor/pkg/channels/telegram"   // Triggers init() registration
    _ "github.com/ashir6892/thor/pkg/channels/discord"
    _ "github.com/ashir6892/thor/pkg/channels/your_new_channel"  // New addition
)
```
...
import (
    ...
    "github.com/ashir6892/thor/pkg/channels"
    "github.com/ashir6892/thor/pkg/config"
    "github.com/ashir6892/thor/pkg/identity"
    "github.com/ashir6892/thor/pkg/logger"
)
...
**This means**:
- Channels implementing `TypingCapable` (Telegram, Discord, LINE, Nano) do not need to manually call `StartTyping` + `RecordTypingStop` in `handleMessage`
...
- Channels implementing `PlaceholderCapable` (Telegram, Discord, Nano) do not need to manually send placeholder messages and call `RecordPlaceholder` in `handleMessage`
...
// cmd/thor/internal/gateway/helpers.go
import (
    _ "github.com/ashir6892/thor/pkg/channels/matrix"
)
```
...
| `pkg/channels/nano/` | `"nano"` | WebhookHandler (Nano Protocol), TypingCapable, PlaceholderCapable |
...
4. **Nano Protocol**: `pkg/channels/nano/` implements a custom Thor native protocol channel that receives messages via webhook.