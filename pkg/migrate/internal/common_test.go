...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.thor")
	assert.Equal(t, "/home/user/.thor/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.thor/workspace/file.txt", "/home/user/.thor")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".thor"), result)
}
