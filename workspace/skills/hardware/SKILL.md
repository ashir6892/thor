---
name: hardware
description: Read and control I2C and SPI peripherals on embedded Linux boards (LicheeRV Nano, MaixCAM, NanoKVM).
homepage: https://wiki.github.com/ashir6892/hardware/en/lichee/RV_Nano/1_intro.html
...
Most I2C/SPI pins are shared with WiFi on embedded Linux boards. You must configure pinmux before use.
